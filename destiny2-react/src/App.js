...
function App() {
  useEffect(() => {
    document.querySelector(
      "html"
    ).style.backgroundImage = sessionStorage.getItem("theme");
  }, []);
  ...
  return (
    <div className="app">
      ...
      <Routes>
        ...
        <Route
          path="/bgs/videos"
          element={<VideosCatalogue setVideoName={setVideoName} />}
        />
        <Route
          path="/bgs/videos/:id"
          element={<VideoComponent videoName={videoName} />}
        />
